...
def get_CIFAR10_data(directory = True, path = None,
    ...
    if directory == False:
        ...
        path = os.path.join(path_root,"datasets", "cifar-10-batches-py")
        
        
    else: path = r'D:\jordi\python2021\cs231n\assignment1\assignment1\cifar-10-batches-py'
