...
class TwoLayerNet(object):
    ...
    def __init__(
        ...
        #        W1 = np.reshape(W1, (input_dim, num_classes))
        #        
        #        W2 = np.random.normal(loc = 0.0, scale = weight_scale, 
        #                                             size = (input_dim *  num_classes))
        #        W2 = np.reshape(W1, (input_dim, num_classes))
    ...
    def loss(self, X, y = None):
        ...
        x_inputs = X
        #x_i are the scores input to the next layer
        #cache_i: (x_i, w_i, b_i)
        x1, cache1 = affine_relu_forward(x_inputs, W1, b1)
        ...
        #penalizing all the network
        #normalizing by the number of layers (* 1/N_layers)
